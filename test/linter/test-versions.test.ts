...
describe('test-versions', () => {
  ...
  it('should log error when version_added is "preview" and version_removed is some version', () => {
    support.chrome = {
  ...
  it('should pass when version_added is some version and version_removed is "preview"', () => {
    support.chrome = {
      version_added: '1',
  ...
  it('should log error when both version_added and version_removed are "preview"', () => {
    support.chrome = {
      version_added: 'preview',
      version_removed: 'preview',
    };
  ...
  it('should log error when version_added is "preview" and version_removed is some version', () => {
    ...
    assert.equal(logger.messages.length, 1);
    assert.ok(logger.messages[0].message.includes('a valid version'));
  });
});
