...
- A 0-based `index` property is added to every release object, ordered ascending by version. You can use it to construct an ordered array of releases without parsing version strings.
