...
| `non-required behavior`           | Non-required behavior that does not warrant `"partial_implementation": true`.                                                                                                                |
| `platform limitation`             | Behavior limited by the operating system or device platform.                                                                                                                                 |
